...
class ResNet(nn.Module):
    def __init__(self, block, layers=(3, 4, 23, 3), extra_dim=0):
        ...
        self.conv1 = nn.Conv2d(1+extra_dim, 16, kernel_size=7, stride=2, padding=3, bias=False)
...
def resnet18(pretrained=False, extra_dim=0):
...
def resnet50(pretrained=False, extra_dim=0):
